...
include "../controlador/controlador_registrar_suministro.php"; // Controlador nuevo
...
<div class="page-content">
    <h4 class="text-center text-secondary">REGISTRO DE SUMINISTROS</h4>
        ...
        <form action="" method="POST" autocomplete="off" class="w-100 js-validate" novalidate>
            ...
            <div class="form-row">
                <div class="form-group col-12 col-md-6">
                    <label for="txtnombre" class="form-label">Nombre del suministro</label>
                    <input type="text" id="txtnombre" name="txtnombre" class="form-control" placeholder="Ej: Aceite 15W40" maxlength="200" required>
                    <small class="form-text">Nombre del suministro o material.</small>
                    <div class="invalid-feedback">Ingrese el nombre del suministro.</div>
                </div>

                <div class="form-group col-12 col-md-6">
                    <label for="txtdescripcion" class="form-label">Descripción</label>
                    <input type="text" id="txtdescripcion" name="txtdescripcion" class="form-control" placeholder="Ej: Aceite sintético para motor diesel" maxlength="500" required>
                    <small class="form-text">Breve descripción del suministro.</small>
            ...
            <div class="actions-row">
                <div class="actions-right">
                    <a href="suministros.php" class="btn btn-secondary btn-rounded">Atrás</a>
