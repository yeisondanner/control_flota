...
include "../controlador/controlador_registrar_unidadminera.php";
...
<div class="page-content">
  <h4 class="text-center text-secondary">REGISTRO DE UNIDAD MINERA</h4>
    ...
    <form action="" method="POST" autocomplete="off" class="w-100 js-validate" novalidate>
      ...
      <div class="form-row">
        <div class="form-group col-12 col-md-6">
          <label for="txtunidad" class="form-label">Unidad Minera</label>
          <input type="text" id="txtunidad" name="txtunidad" class="form-control" placeholder="Ej: Mina XYZ" maxlength="100" required>
          <small class="form-text">Nombre de la unidad minera.</small>
          <div class="invalid-feedback">Ingrese el nombre de la unidad minera.</div>
        </div>

        <div class="form-group col-12 col-md-6">
          <label for="txtdescripcion" class="form-label">Descripción</label>
          <input type="text" id="txtdescripcion" name="txtdescripcion" class="form-control" placeholder="Descripción de la unidad" maxlength="100" required>
          <small class="form-text">Breve descripción de la unidad minera.</small>
      ...
      <div class="actions-row">
        <div class="actions-right">
          <a href="unidad_minera.php" class="btn btn-secondary btn-rounded">Atrás</a>
